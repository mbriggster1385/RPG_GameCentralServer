...
class GameConfigDialog:
	...
	def Create_Toplevel(self):
		...
		self.root.toplevel_dialog_yes_button = ttk.Button(self.root.toplevel_dialog, text='Accept', command=self.Close_Toplevel)
		self.root.toplevel_dialog_yes_button.pack(side='left', fill='x', expand=True)

		self.root.toplevel_dialog_no_button = ttk.Button(self.root.toplevel_dialog, text='Cancel')
